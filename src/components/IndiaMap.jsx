...
const CITIES = [
  { id: "gurugram", name: "Gurugram (HQ)", state: "Haryana", x: 316, y: 330, fact: "Headquarters — senior advisory team & doorstep documentation origin." },
      ...
      <div className="flip-card-inner" data-flipped={flipped}>
        ...
        <div className="flip-card-face flip-card-face-back bg-teal-dark rounded-2xl p-6 sm:p-8 flex flex-col justify-center">
          ...
          <h3 className="font-display font-bold text-xl text-white mb-3">
            Every city on that map is served from one desk in Gurugram.
          </h3>
          <p className="text-sm text-cream/80 leading-relaxed mb-5">
            ...
            senior team of financial experts at our Gurugram headquarters — then executed locally through vetted
            on-ground partners in 120+ cities for documentation pickup and disbursal. Same advisor, start to finish,
            no matter which city you're calling from.
          </p>
